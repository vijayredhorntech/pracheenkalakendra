                ...
                <div class="card mb-3">
                    <div class="card-body p-4">
                        <div>
                            ...
                            <h4 class="mb-3">Notification Date <span class="text-danger">*</span></h4>
                ...
                <div class="table-responsive scrollbar mx-n1 px-1">
                    <table class="table table-sm fs-9 mb-0">
                        ...
                        <tr>
                            ...
                            <th class="sort align-middle ps-8" scope="col" data-sort="customer" style="width:30%;">NOTIFICATION NAME</th>
                            <th class="sort align-middle ps-8" scope="col" data-sort="customer" style="width:30%;">NOTIFICATION FILE</th>
